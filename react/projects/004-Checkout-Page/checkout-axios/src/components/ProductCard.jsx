...
const ProductCard = ({ item, handlePlus, handleMinus, handleRemove }) => {
  const { id, image, name, price, dampingRate, amount } = item;
  return (
    <div className="card shadow-lg mb-3">
      <div className="row g-0">
        <div className="col-md-5">
          <img src={image} className="w-100 h-100 rounded-start" alt={name} title={name} />
        </div>
        <div className="col-md-7">
          <div className="card-body">
            ...
            <div className="product-removal mt-4" onClick={() => handleRemove(id)}>
